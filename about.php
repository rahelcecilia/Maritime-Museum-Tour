    ...
    <section id="alt-services" class="alt-services">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row justify-content-around gy-4">
          <div class="col-lg-6 img-bg" style="background-image: url(assets/m-img/Foto-5.jpg);" data-aos="zoom-in" data-aos-delay="100"></div>

          <div class="col-lg-5 d-flex flex-column justify-content-center">
            <h3>Welcome to Museum Maritime Tour</h3>
            <p>Maritime Museum tour is an online platform media portal that explain the importance of Pasopati, and a platform that capable to provide direct service for customer if they want to have direct approach in the museum itself. </p>
    ...
    <section id="alt-services-2" class="alt-services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row justify-content-around gy-4">
          ...
          <div class="col-lg-5 d-flex flex-column justify-content-center">
            <h3>Maritime Museum Tour Vision & Mission</h3>
            <p>We hope that people can become more knowledgeable for people to keep history alive.</p>
          ...
          <div class="col-lg-6 img-bg" style="background-image: url(assets/m-img/Foto-6.jpg);" data-aos="zoom-in" data-aos-delay="100"></div>
        </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-5">
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="500">
            <div class="member-img">
              <img src="assets/m-img/Team-5.jpeg" class="img-fluid" alt="">
              <div class="social">
                <a href="#"><i class="bi bi-twitter"></i></a>
                <a href="#"><i class="bi bi-facebook"></i></a>
                <a href="#"><i class="bi bi-instagram"></i></a>
