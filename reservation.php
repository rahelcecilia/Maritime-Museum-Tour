...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/hero-carousel/hero-carousel-1.jpg" rel="icon">
  <link href="assets/img/hero-carousel/hero-carousel-1.jpg" rel="apple-touch-icon">
...
<body>
  ...
  <main id="main">
    ...
    <!-- ======= Breadcrumbs ======= -->
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url('assets/m-img/Foto-3.jpg');">
    ...
    <section id="blog" class="blog">
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <h3>Book your tickets now!</h3>
				<div method="POST" action="" enctype="multipart/form-data"> <br>
				
				<p><strong>Name</strong></p>
				<p><input type="textarea" class="form-control" id="name" name="name" placeholder="Enter your name" required></p> <br>
			
        <p><strong>Email</strong></p>
				<p><input type="textarea" class="form-control" id="email" name="email" placeholder="Enter your email" required></p> <br>
...
<option value="Papua Highlands">Papua Highlands</option>
...
<option value="Western New Guinea">Western New Guinea</option>

          </select>
        </div> <br>

				<p><strong>Adults</strong></p>
				<p><input type="number" class="form-control" id="adults" name="adults" placeholder="the number of adults" required></p> <br>
				
				<p><strong>Children</strong></strong></p>
				<p><input type="number" class="form-control" id="children" name="children" placeholder="the number of children" required></p> <br>
